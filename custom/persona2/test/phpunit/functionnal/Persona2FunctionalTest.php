...
/**
 * \file    test/phpunit/Persona2FunctionalTest.php
 * \ingroup persona2
 ...
 *
 * @package Testpersona2
 */
class Persona2FunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	{
		$this->url('/custom/persona2/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('persona2/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/persona2/admin/about.php');
		$this->authenticate();
		return $this->assertContains('persona2/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('persona2widget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modPersona2_Persona2Triggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modPersona2_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
