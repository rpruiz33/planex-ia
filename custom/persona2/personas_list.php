...
/**
 *   	\file       personas_list.php
 *		\ingroup    persona2
 *		\brief      List page for personas
 */
...
require_once __DIR__.'/class/personas.class.php';
...
if ($enablepermissioncheck) {
	...
	$permissiontoadd = $user->hasRight('persona2', 'personas', 'write');
	$permissiontodelete = $user->hasRight('persona2', 'personas', 'delete');
} else {
	$permissiontoread = 1;
	$permissiontoadd = 1;
...
$title = $langs->trans("Personass");
//$help_url = "EN:Module_Personas|FR:Module_Personas_FR|ES:Módulo_Personas";
$help_url = '';
$morejs = array();
$morecss = array();
...
if ($num == 1 && getDolGlobalInt('MAIN_SEARCH_DIRECT_OPEN_IF_ONLY_ONE') && $search_all && !$page) {
	...
	$id = $obj->rowid;
	header("Location: ".dol_buildpath('/persona2/personas_card.php', 1).'?id='.((int) $id));
	exit;
}
...
$newcardbutton .= dolGetButtonTitle($langs->trans('New'), '', 'fa fa-plus-circle', dol_buildpath('/persona2/personas_card.php', 1).'?action=create&backtopage='.urlencode($_SERVER['PHP_SELF']), '', $permissiontoadd);

print_barre_liste($title, $page, $_SERVER["PHP_SELF"], $param, $sortfield, $sortorder, $massactionbutton, $num, $nbtotalofrecords, 'object_'.$object->picto, 0, $newcardbutton, '', $limit, 0, 0, 1);

// Add code for pre mass action (confirmation or email presend form)
$topicmail = "SendPersonasRef";
$modelmail = "personas";
$objecttmp = new Personas($db);
