...
/**
 *  \file       core/modules/persona2/doc/pdf_standard.modules.php
 *  \ingroup    persona2
...
/**
 *	Class to manage PDF template standard_personas
 */
class pdf_standard_personas extends ModelePDFPersonas
{
	/**
	...
	public function write_file($object, $outputlangs, $srctemplatepath = '', $hidedetails = 0, $hidedesc = 0, $hideref = 0)
	{
		...
		*/
		...
		if ($conf->persona2->dir_output.'/personas') {
			$object->fetch_thirdparty();

			// Definition of $dir and $file
			if ($object->specimen) {
				$dir = $conf->persona2->dir_output.'/personas';
				$file = $dir."/SPECIMEN.pdf";
			} else {
				$objectref = dol_sanitizeFileName($object->ref);
				$dir = $conf->persona2->dir_output.'/personas/'.$objectref;
	...
	protected function _pagehead(&$pdf, $object, $showaddress, $outputlangs, $outputlangsbis = null)
	{
		...
		if ($object->statut == $object::STATUS_DRAFT && getDolGlobalString('PERSONA2_DRAFT_WATERMARK')) {
			pdf_watermark($pdf, $outputlangs, $this->page_hauteur, $this->page_largeur, 'mm', dol_escape_htmltag(getDolGlobalString('PERSONA2_DRAFT_WATERMARK')));
		}
